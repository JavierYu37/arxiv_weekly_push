...
参考改进 https://github.com/NN0202/arxiv_daily_paper_push.git  
...
## 🫡 私人定制
-  daily_paper_ai.py 专注于人工智能/计算机科学领域方向的论文检索，主要获取arxiv中的论文，可通过修改advanced_query调整关键词
-  daily_paper_bio.py 专注于生物科学领域方向的论文检索，主要获取arxiv/Europe PMC中的论文，可通过修改advanced_query调整关键词